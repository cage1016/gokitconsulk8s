...
import (
	...
	"github.com/cage1016/gokitsonsulk8s/pkg/foosvc/transports"
)
...
func startGRPCServer(cfg config, hs *health.Server, grpcServer pb.FoosvcServer, logger log.Logger, errs chan error) {
